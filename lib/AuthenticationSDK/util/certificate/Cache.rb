...
# P12 file certificate Cache
  module Certificate
    class Cache
      def fetchCached(filePath, p12File, keyPass, cacheObj)
        ...
        if File.exist?(filePath)
          ...
          certificateFromP12File = get(p12File, keyPass, cacheObj, currentFileLastModifiedTime)
      ...
      def get(p12File, keyPass, cacheObj, currentFileLastModifiedTime)
